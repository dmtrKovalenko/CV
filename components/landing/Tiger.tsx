...
import { useTigerStyles } from "./tigerStyles";
    ...
    >
      ...
      >
		...
		230.6,575.9 191.6,584.6 237,580.8 237,558.7 221.5,554.8 221.6,543.2 	"
          ...
          />
          <path id="XMLID_339_" className={styles.st15} d="M142.8,517.8" />
          <polygon
            id="XMLID_338_"
            className={styles.st15}
		...
		243.3,575.9 282.4,584.6 237,580.8 237,558.7 252.5,554.8 252.4,543.2 	"
          ...
          />
          <path id="XMLID_130_" className={styles.st15} d="M331.2,517.8" />
          <polygon
            id="XMLID_129_"
            className={styles.st15}
...
export default React.memo(Tiger, () => true);
